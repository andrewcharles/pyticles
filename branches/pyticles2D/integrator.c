/* Generated by Cython 0.11.2 on Sun Jun  7 13:48:35 2009 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API___integrator
#include "stdlib.h"
...
static char __pyx_mdoc[] = " This module contains generic numerical integration methods.\n    Copyright (C) Andrew Charles 2008\n    BSD License\n    \n";
...
/* Module declarations from _integrator */

#define __Pyx_MODULE_NAME "_integrator"
int __pyx_module_is_main__integrator = 0;

/* Implementation of _integrator */
static PyObject *__pyx_int_2;
static char __pyx_k___main__[] = "__main__";
static PyObject *__pyx_kp___main__;
static char __pyx_k_get_state[] = "get_state";
static PyObject *__pyx_kp_get_state;
static char __pyx_k_calc_derivs[] = "calc_derivs";
static PyObject *__pyx_kp_calc_derivs;
static char __pyx_k_get_derivs[] = "get_derivs";
static PyObject *__pyx_kp_get_derivs;
...
/* "/Users/acharles/masters/active/pyticles/integrator.pyx":13
 * cimport numpy as np
 * 
...
static PyObject *__pyx_pf_11_integrator_euler(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11_integrator_euler[] = " Simple euler integration. So simple it's pointless to wrap it like\n        this, except as an exercise to work out the interface.\n\n        state: vector describing the system's state.\n        get_state: a function to obtain the system state\n\tcalc_derivs: calculates the derivatives for the system\n\tget_derivs: gathers the derivates from the system into a vector\n        scatter_state: a function to scatter the state vector to a more\n                       descriptive objects (e.g. an n-body system organised in particles)\n        dt: timestep size\n\n        These are usually functions of an object, e.g.\n\n        euler(particle.get_state,particle.get_derivs,particle.set_state,0.1)\n        \n        typical application is to a particle system:\n\tdef get_state():\n          x[0,:] = p.r[:,1]\n          x[1,:] = p.r[:,2]\n          x[2,:] = p.v[:,1]\n          ...etc\n    ";
static PyObject *__pyx_pf_11_integrator_euler(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_get_state = 0;
  PyObject *__pyx_v_calc_derivs = 0;
  PyObject *__pyx_v_get_derivs = 0;
  PyObject *__pyx_v_set_state = 0;
  PyObject *__pyx_v_dt = 0;
  PyObject *__pyx_v_x;
  PyObject *__pyx_v_xdot;
  PyObject *__pyx_r = NULL;
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  static PyObject **__pyx_pyargnames[] = {&__pyx_kp_get_state,&__pyx_kp_calc_derivs,&__pyx_kp_get_derivs,&__pyx_kp_set_state,&__pyx_kp_dt,0};
  __Pyx_SetupRefcountContext("euler");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  0:
      values[0] = PyDict_GetItem(__pyx_kwds, __pyx_kp_get_state);
      if (likely(values[0])) kw_args--;
      else goto __pyx_L5_argtuple_error;
      case  1:
      values[1] = PyDict_GetItem(__pyx_kwds, __pyx_kp_calc_derivs);
      if (likely(values[1])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("euler", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_kp_get_derivs);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("euler", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_kp_set_state);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("euler", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  4:
      values[4] = PyDict_GetItem(__pyx_kwds, __pyx_kp_dt);
      if (likely(values[4])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("euler", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "euler") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_get_state = values[0];
    __pyx_v_calc_derivs = values[1];
    __pyx_v_get_derivs = values[2];
    __pyx_v_set_state = values[3];
    __pyx_v_dt = values[4];
  } else if (PyTuple_GET_SIZE(__pyx_args) != 5) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_get_state = PyTuple_GET_ITEM(__pyx_args, 0);
    __pyx_v_calc_derivs = PyTuple_GET_ITEM(__pyx_args, 1);
    __pyx_v_get_derivs = PyTuple_GET_ITEM(__pyx_args, 2);
    __pyx_v_set_state = PyTuple_GET_ITEM(__pyx_args, 3);
    __pyx_v_dt = PyTuple_GET_ITEM(__pyx_args, 4);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("euler", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("_integrator.euler");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_v_x = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_xdot = Py_None; __Pyx_INCREF(Py_None);

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":36
 *           ...etc
 *     """
 *     calc_derivs()             # <<<<<<<<<<<<<<
 *     x = get_state()
 *     xdot = get_derivs()
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_calc_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":37
 *     """
 *     calc_derivs()
 *     x = get_state()             # <<<<<<<<<<<<<<
 *     xdot = get_derivs()
 *     x = x+xdot*dt
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_get_state, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":38
 *     calc_derivs()
 *     x = get_state()
 *     xdot = get_derivs()             # <<<<<<<<<<<<<<
 *     x = x+xdot*dt
 *     set_state(x)
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_get_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_xdot);
  __pyx_v_xdot = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":39
 *     x = get_state()
 *     xdot = get_derivs()
 *     x = x+xdot*dt             # <<<<<<<<<<<<<<
 *     set_state(x)
 * 
 */
  __pyx_t_1 = PyNumber_Multiply(__pyx_v_xdot, __pyx_v_dt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyNumber_Add(__pyx_v_x, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":40
 *     xdot = get_derivs()
 *     x = x+xdot*dt
 *     set_state(x)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = PyObject_Call(__pyx_v_set_state, ((PyObject *)__pyx_t_2), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
...
/* "/Users/acharles/masters/active/pyticles/integrator.pyx":43
 * 
 * 
...
static PyObject *__pyx_pf_11_integrator_imp_euler(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11_integrator_imp_euler[] = " Improved euler integration (two step predictor-corrector\n    ";
static PyObject *__pyx_pf_11_integrator_imp_euler(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_get_state = 0;
  PyObject *__pyx_v_calc_derivs = 0;
  PyObject *__pyx_v_get_derivs = 0;
  PyObject *__pyx_v_set_state = 0;
  PyObject *__pyx_v_dt = 0;
  PyObject *__pyx_v_x_start;
  PyObject *__pyx_v_xdot;
  PyObject *__pyx_v_c1;
  PyObject *__pyx_v_x;
  PyObject *__pyx_v_c2;
  ...
  PyObject *__pyx_t_2 = NULL;
  static PyObject **__pyx_pyargnames[] = {&__pyx_kp_get_state,&__pyx_kp_calc_derivs,&__pyx_kp_get_derivs,&__pyx_kp_set_state,&__pyx_kp_dt,0};
  __Pyx_SetupRefcountContext("imp_euler");
  __pyx_self = __pyx_self;
  if (unlikely(__pyx_kwds)) {
    Py_ssize_t kw_args = PyDict_Size(__pyx_kwds);
    PyObject* values[5] = {0,0,0,0,0};
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("imp_euler", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_kp_get_derivs);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("imp_euler", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_kp_set_state);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("imp_euler", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  4:
      values[4] = PyDict_GetItem(__pyx_kwds, __pyx_kp_dt);
      if (likely(values[4])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("imp_euler", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "imp_euler") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_get_state = values[0];
    __pyx_v_calc_derivs = values[1];
    __pyx_v_get_derivs = values[2];
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("imp_euler", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("_integrator.imp_euler");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_v_x_start = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_xdot = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_c1 = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_x = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_c2 = Py_None; __Pyx_INCREF(Py_None);

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":47
 *     """
 *     # First guess
 *     calc_derivs()             # <<<<<<<<<<<<<<
 *     x_start = get_state()
 *     xdot = get_derivs()
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_calc_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":48
 *     # First guess
 *     calc_derivs()
 *     x_start = get_state()             # <<<<<<<<<<<<<<
 *     xdot = get_derivs()
 *     c1 = xdot*dt
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_get_state, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_x_start);
  __pyx_v_x_start = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":49
 *     calc_derivs()
 *     x_start = get_state()
 *     xdot = get_derivs()             # <<<<<<<<<<<<<<
 *     c1 = xdot*dt
 ...
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_get_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_xdot);
  __pyx_v_xdot = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":50
 *     x_start = get_state()
 *     xdot = get_derivs()
 *     c1 = xdot*dt             # <<<<<<<<<<<<<<
 *     # Take Euler step and get the second term
 *     x = x_start + c1
 */
  __pyx_t_1 = PyNumber_Multiply(__pyx_v_xdot, __pyx_v_dt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_c1);
  __pyx_v_c1 = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":52
 *     c1 = xdot*dt
 *     # Take Euler step and get the second term
 *     x = x_start + c1             # <<<<<<<<<<<<<<
 *     set_state(x)
 *     calc_derivs()
 */
  __pyx_t_1 = PyNumber_Add(__pyx_v_x_start, __pyx_v_c1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":53
 *     # Take Euler step and get the second term
 *     x = x_start + c1
 *     set_state(x)             # <<<<<<<<<<<<<<
 *     calc_derivs()
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_v_x);
  __pyx_t_2 = PyObject_Call(__pyx_v_set_state, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":54
 *     x = x_start + c1
 *     set_state(x)
 *     calc_derivs()             # <<<<<<<<<<<<<<
 *     xdot = get_derivs()
 *     c2 = xdot * dt
 */
  __pyx_t_2 = PyObject_Call(__pyx_v_calc_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":55
 *     set_state(x)
 *     calc_derivs()
 *     xdot = get_derivs()             # <<<<<<<<<<<<<<
 *     c2 = xdot * dt
 *     x = x_start + (c1+c2)/2
 */
  __pyx_t_2 = PyObject_Call(__pyx_v_get_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_v_xdot);
  __pyx_v_xdot = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":56
 *     calc_derivs()
 *     xdot = get_derivs()
 *     c2 = xdot * dt             # <<<<<<<<<<<<<<
 *     x = x_start + (c1+c2)/2
 *     set_state(x)
 */
  __pyx_t_2 = PyNumber_Multiply(__pyx_v_xdot, __pyx_v_dt); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_v_c2);
  __pyx_v_c2 = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":57
 *     xdot = get_derivs()
 *     c2 = xdot * dt
 *     x = x_start + (c1+c2)/2             # <<<<<<<<<<<<<<
 *     set_state(x)
 * 
 */
  __pyx_t_2 = PyNumber_Add(__pyx_v_c1, __pyx_v_c2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_int_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyNumber_Add(__pyx_v_x_start, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_t_2;
  ...
  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":58
 *     c2 = xdot * dt
 *     x = x_start + (c1+c2)/2
 *     set_state(x)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_x);
  __Pyx_GIVEREF(__pyx_v_x);
  __pyx_t_1 = PyObject_Call(__pyx_v_set_state, ((PyObject *)__pyx_t_2), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
/* "/Users/acharles/masters/active/pyticles/integrator.pyx":61
 * 
 * 
...
static PyObject *__pyx_pf_11_integrator_rk4(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11_integrator_rk4[] = " runge kutta fourth order integrator\n    ";
static PyObject *__pyx_pf_11_integrator_rk4(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_get_state = 0;
  PyObject *__pyx_v_calc_derivs = 0;
  PyObject *__pyx_v_get_derivs = 0;
  PyObject *__pyx_v_set_state = 0;
  ...
  static PyObject **__pyx_pyargnames[] = {&__pyx_kp_get_state,&__pyx_kp_calc_derivs,&__pyx_kp_get_derivs,&__pyx_kp_set_state,&__pyx_kp_dt,0};
  __Pyx_SetupRefcountContext("rk4");
  __pyx_self = __pyx_self;
  if (unlikely(__pyx_kwds)) {
    Py_ssize_t kw_args = PyDict_Size(__pyx_kwds);
    PyObject* values[5] = {0,0,0,0,0};
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("rk4", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_kp_get_derivs);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("rk4", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_kp_set_state);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("rk4", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  4:
      values[4] = PyDict_GetItem(__pyx_kwds, __pyx_kp_dt);
      if (likely(values[4])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("rk4", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "rk4") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_get_state = values[0];
    __pyx_v_calc_derivs = values[1];
    __pyx_v_get_derivs = values[2];
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("rk4", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("_integrator.rk4");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_v_x_start = Py_None; __Pyx_INCREF(Py_None);
  __pyx_v_xdot = Py_None; __Pyx_INCREF(Py_None);
  ...
  __pyx_v_c4 = Py_None; __Pyx_INCREF(Py_None);

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":66
 * 
 *     # First guess
 *     calc_derivs()             # <<<<<<<<<<<<<<
 *     x_start = get_state()
 *     xdot = get_derivs()
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_calc_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 66; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":67
 *     # First guess
 *     calc_derivs()
 *     x_start = get_state()             # <<<<<<<<<<<<<<
 *     xdot = get_derivs()
 *     c1 = xdot*dt
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_get_state, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_x_start);
  __pyx_v_x_start = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":68
 *     calc_derivs()
 *     x_start = get_state()
 *     xdot = get_derivs()             # <<<<<<<<<<<<<<
 *     c1 = xdot*dt
 * 
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_get_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_xdot);
  __pyx_v_xdot = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":69
 *     x_start = get_state()
 *     xdot = get_derivs()
 *     c1 = xdot*dt             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyNumber_Multiply(__pyx_v_xdot, __pyx_v_dt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_c1);
  __pyx_v_c1 = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":72
 * 
 *     # Take half step and get the second term
 *     x = x_start + c1 / 2.0             # <<<<<<<<<<<<<<
 *     set_state(x)
 *     calc_derivs()
 */
  __pyx_t_1 = PyFloat_FromDouble(2.0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyNumber_Divide(__pyx_v_c1, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Add(__pyx_v_x_start, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_t_1;
  ...
  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":73
 *     # Take half step and get the second term
 *     x = x_start + c1 / 2.0
 *     set_state(x)             # <<<<<<<<<<<<<<
 *     calc_derivs()
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_x);
  __Pyx_GIVEREF(__pyx_v_x);
  __pyx_t_2 = PyObject_Call(__pyx_v_set_state, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":74
 *     x = x_start + c1 / 2.0
 *     set_state(x)
 *     calc_derivs()             # <<<<<<<<<<<<<<
 *     xdot = get_derivs()
 *     c2 = xdot * dt
 */
  __pyx_t_2 = PyObject_Call(__pyx_v_calc_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":75
 *     set_state(x)
 *     calc_derivs()
 *     xdot = get_derivs()             # <<<<<<<<<<<<<<
 *     c2 = xdot * dt
 * 
 */
  __pyx_t_2 = PyObject_Call(__pyx_v_get_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_v_xdot);
  __pyx_v_xdot = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":76
 *     calc_derivs()
 *     xdot = get_derivs()
 *     c2 = xdot * dt             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = PyNumber_Multiply(__pyx_v_xdot, __pyx_v_dt); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_v_c2);
  __pyx_v_c2 = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":79
 * 
 *     # Take another half step with c2 to get c3
 *     x = x_start + c2 / 2.0             # <<<<<<<<<<<<<<
 *     set_state(x)
 *     calc_derivs()
 */
  __pyx_t_2 = PyFloat_FromDouble(2.0); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_v_c2, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyNumber_Add(__pyx_v_x_start, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_t_2;
  ...
  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":80
 *     # Take another half step with c2 to get c3
 *     x = x_start + c2 / 2.0
 *     set_state(x)             # <<<<<<<<<<<<<<
 *     calc_derivs()
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_x);
  __Pyx_GIVEREF(__pyx_v_x);
  __pyx_t_1 = PyObject_Call(__pyx_v_set_state, ((PyObject *)__pyx_t_2), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":81
 *     x = x_start + c2 / 2.0
 *     set_state(x)
 *     calc_derivs()             # <<<<<<<<<<<<<<
 *     xdot = get_derivs()
 *     c3 = xdot * dt
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_calc_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":82
 *     set_state(x)
 *     calc_derivs()
 *     xdot = get_derivs()             # <<<<<<<<<<<<<<
 *     c3 = xdot * dt
 * 
 */
  __pyx_t_1 = PyObject_Call(__pyx_v_get_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_xdot);
  __pyx_v_xdot = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":83
 *     calc_derivs()
 *     xdot = get_derivs()
 *     c3 = xdot * dt             # <<<<<<<<<<<<<<
 * 
 *     # c4 step
 */
  __pyx_t_1 = PyNumber_Multiply(__pyx_v_xdot, __pyx_v_dt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_c3);
  __pyx_v_c3 = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":86
 * 
 *     # c4 step
 *     x = x_start + c3             # <<<<<<<<<<<<<<
 *     set_state(x)
 *     calc_derivs()
 */
  __pyx_t_1 = PyNumber_Add(__pyx_v_x_start, __pyx_v_c3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":87
 *     # c4 step
 *     x = x_start + c3
 *     set_state(x)             # <<<<<<<<<<<<<<
 *     calc_derivs()
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_x);
  __Pyx_GIVEREF(__pyx_v_x);
  __pyx_t_2 = PyObject_Call(__pyx_v_set_state, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":88
 *     x = x_start + c3
 *     set_state(x)
 *     calc_derivs()             # <<<<<<<<<<<<<<
 *     xdot = get_derivs()
 *     c4 = xdot * dt
 */
  __pyx_t_2 = PyObject_Call(__pyx_v_calc_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":89
 *     set_state(x)
 *     calc_derivs()
 *     xdot = get_derivs()             # <<<<<<<<<<<<<<
 *     c4 = xdot * dt
 * 
 */
  __pyx_t_2 = PyObject_Call(__pyx_v_get_derivs, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_v_xdot);
  __pyx_v_xdot = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":90
 *     calc_derivs()
 *     xdot = get_derivs()
 *     c4 = xdot * dt             # <<<<<<<<<<<<<<
 * 
 *     # Final step
 */
  __pyx_t_2 = PyNumber_Multiply(__pyx_v_xdot, __pyx_v_dt); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_v_c4);
  __pyx_v_c4 = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":93
 * 
 *     # Final step
 ...
 * 
 */
  __pyx_t_2 = PyFloat_FromDouble((1.0 / 6.0)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = PyNumber_Multiply(__pyx_int_2, __pyx_v_c2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Add(__pyx_v_c1, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Multiply(__pyx_int_2, __pyx_v_c3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = PyNumber_Add(__pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Add(__pyx_t_4, __pyx_v_c4); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Add(__pyx_v_x_start, __pyx_t_4); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_t_1;
  ...
  /* "/Users/acharles/masters/active/pyticles/integrator.pyx":94
 *     # Final step
 *     x = x_start + (1.0/6.0) * (c1 + 2*c2 + 2*c3 + c4)
 *     set_state(x)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_v_x);
  __Pyx_GIVEREF(__pyx_v_x);
  __pyx_t_4 = PyObject_Call(__pyx_v_set_state, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("euler"), (PyCFunction)__pyx_pf_11_integrator_euler, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_11_integrator_euler)},
  {__Pyx_NAMESTR("imp_euler"), (PyCFunction)__pyx_pf_11_integrator_imp_euler, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_11_integrator_imp_euler)},
  {__Pyx_NAMESTR("rk4"), (PyCFunction)__pyx_pf_11_integrator_rk4, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_11_integrator_rk4)},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_calc_derivs, __pyx_k_calc_derivs, sizeof(__pyx_k_calc_derivs), 1, 1, 1},
  {&__pyx_kp_get_derivs, __pyx_k_get_derivs, sizeof(__pyx_k_get_derivs), 1, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_integrator(void); /*proto*/
PyMODINIT_FUNC init_integrator(void)
#else
PyMODINIT_FUNC PyInit__integrator(void); /*proto*/
PyMODINIT_FUNC PyInit__integrator(void)
#endif
{
  #ifdef CYTHON_REFNANNY
  ...
  __pyx_refchk = __Pyx_Refnanny->NewContext("PyMODINIT_FUNC PyInit__integrator(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_integrator"), __pyx_methods, __pyx_mdoc, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main__integrator) {
 ...
 */
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("_integrator");
